...
class AdminProfile extends StatefulWidget {
  final int u_id;      // Add u_id
  final String username;  // Add username

  const AdminProfile({Key? key, required this.u_id, required this.username}) : super(key: key);
...
class _AdminProfileState extends State<AdminProfile> {
  ...
  Future<ProfileModel> getProfile() async {
    ...
    String? savedUsername = widget.username;

    print("usernamessssssssssssss ${widget.u_id}   ${widget.username}");
