class UnmatchingPartyRes {
  String? message;
  int? statusCode;
  List<UnmatchParty>? data;
  int? totalCount;

  UnmatchingPartyRes(
      {this.message, this.statusCode, this.data, this.totalCount});

  UnmatchingPartyRes.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    statusCode = json['statusCode'];
    if (json['data'] != null) {
      data = <UnmatchParty>[];
      json['data'].forEach((v) {
        data!.add(new UnmatchParty.fromJson(v));
      });
    }
...
class UnmatchParty {
  ...
  UnmatchParty.fromJson(Map<String, dynamic> json) {
